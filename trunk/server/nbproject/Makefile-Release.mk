...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/${PLATFORM}/myleftchat3.exe

dist/Release/${PLATFORM}/myleftchat3.exe: ${OBJECTFILES}
	${MKDIR} -p dist/Release/${PLATFORM}
	${LINK.c} -o dist/Release/${PLATFORM}/myleftchat3 ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf:
	${RM} -r build/Release
	${RM} dist/Release/${PLATFORM}/myleftchat3.exe
